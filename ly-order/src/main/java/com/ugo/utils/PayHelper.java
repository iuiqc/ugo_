...
import com.ugo.config.PayConfig;
import com.ugo.order.service.OrderService;
...
public class PayHelper {
    ...
    public String createPayUrl(Long orderId) {
        ...
        try {
            ...
            //回调地址
            data.put("notify_url", "http://test.ugo.com/wxpay/notify");
            // 交易类型为扫码支付
            data.put("trade_type", "NATIVE");
            //商品id,使用假数据
            data.put("product_id", "ugo7");
